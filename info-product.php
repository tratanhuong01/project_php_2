            ...
            <div class="info">
                ...
                <div class="info-right">
                    ...
                    <?php 
                        ...
                        $arr = showinfosanpham($ma);
                    ?>
                        <div class="info-right-1-a">
                            <a href=""><img src="pic/picsub/<?= $arr[0]['pic'].".jpg" ?>" alt=""></a>
                        </div>
                        <div class="info-right-1-b">
                            <h3><?= $arr[0]['tensp'] ?></h3>
                            <h4><?= number_format($arr[0]['gia']) ?>đ</h4>
                            <button id="datMua">ĐẶT MUA ,GIAO TẬN NƠI<br>
                                <i>Đổi trả hàng miễn phí</i>
                            </button>
                            <button id="tuVan">TƯ VẤN QUA ĐIỆN THOẠI<br>
                                <b style="color: red;font-size: 20px;">18008118</b>
                            </button>
                            <h3>Loại: <?= $arr[0]['tendanhmuc'] ?></h3>
                        </div>
                    </div>
                    <div class="tite">
                        <ul>
